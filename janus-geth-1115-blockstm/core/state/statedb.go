...
import (
	"errors"
	"fmt"
	"janus-geth-1115-blockstm/tools"
	"math/big"
	"sort"
	"time"
...
func (s *StateDB) getDeletedStateObject(addr common.Address) *stateObject {
	...
	if tools.PreReadState {
		fmt.Println("getDeletedStateObject miss:", addr.Hex())
	}
...
func (s *StateDB) Copy() *StateDB {
	...
	state := &StateDB{
		...
		stateObjects:         make(map[common.Address]*stateObject, testutil.Max(len(s.journal.dirties), len(s.stateObjects))),
